...
<section class="section">${sectionHeading('04','Selecție vizuală','Galerie fără automatism','Imaginile se deschid doar la cerere. Lightbox-ul răspunde la tastatură, Escape și navigare cu săgeți.')}${galleryMarkup(6)}<a class="text-link centered-link" href="/galerie/">Deschide galeria completă</a></section>
...
const galeriePage = page({title:'Galerie | Răgaz 17',description:'Galerie accesibilă cu imagini concept pentru Răgaz 17, fără slideshow automat.',current:'/galerie/',preload:'/images/window-forest.webp',content:`${pageHero('Galerie','Material, lumină, distanță','O selecție de imagini concept pentru aceeași proprietate fictivă, fără slideshow automat.','/images/window-forest.webp')}<section class="section">${sectionHeading('01','Colecție','Deschide doar ceea ce vrei să vezi','Folosește click, Tab, Enter, săgețile stânga și dreapta sau Escape în lightbox.')}${galleryMarkup()}</section>`})
